<div class="page-title mb-3">Gestion de présence</div>
<hr>
<?php 
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row align-items-end">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <select name="class_id" id="class_id" class="form-select" required="required">
                                    <option value="" disabled <?= empty($class_id) ? "selected" : "" ?>> -- Sélectionner ici -- </option>
            ...
            <div class="card shadow mb-3">
                <div class="card-header rounded-0">
                    <div class="card-title">Feuille de Présence</div>
                </div>
                <div class="card-body">
                    <div class="container-fluid">
                        <div class="table-responsive">
                            <table id="attendance-tbl" class="table table-bordered">
                                ...
                                <thead class="bg-primary">
                                    <tr>
                                        <th class="text-center bg-transparent text-light">Étudiants</th>
                                        <th class="text-center bg-transparent text-light">Présent</th>
                                        <th class="text-center bg-transparent text-light">En retard</th>
                                        <th class="text-center bg-transparent text-light">Absent</th>
                                        <th class="text-center bg-transparent text-light">Absence justifiée</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <th class="text-center px-2 py-1 text-dark-emphasis">Cocher/Décocher tout</th>
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="5" class="px-2 py-1 text-center">Aucun étudiant répertorié pour le moment</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
            ...
            <div class="d-flex w-100 justify-content-center align-items-center">
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <button class="btn btn-primary rounded-pill w-100" type="submit">Enregistrer la présence</button>
                </div>
            </div>
            <?php endif; ?>
        </div>
        ...
        $('#manage-attendance').submit(function(e){
            ...
            $('#attendance-tbl .student-row').each(function(){
                ...
                if(has_checks < 1){
                    ...
                    console.log(name)
                    alert(`La présence de ${name} n'est pas encore marquée!`);
                    end_loader()
                    return false;
                }
            })
            $.ajax({
                ...
                error: (err) => {
                    console.error(err)
                    alert("Une erreur s'est produite lors de l'enregistrement des données. Veuillez recharger cette page.")
                    end_loader();
                },
