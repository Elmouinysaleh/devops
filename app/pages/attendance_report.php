<div class="page-title mb-3">Rapport de Présence</div>
<hr>
<?php 
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="card shadow mb-3">
                <div class="card-body">
                    <div class="container-fluid">
                        <fieldset>
                            <legend class="h6"><strong>Légende :</strong></legend>
                            <div class="ps-4">
                                <div><span class="text-success fw-bold">P</span> <span class="ms-1">= Présent</span></div>
                                <div><span class="text-body-emphasis fw-bold">R</span> <span class="ms-1">= En retard</span></div>
                                <div><span class="text-danger fw-bold">A</span> <span class="ms-1">= Absent</span></div>
                                <div><span class="text-primary fw-bold">J</span> <span class="ms-1">= Absence justifiée</span></div>
                            </div>
                        </fieldset>
                    </div>
                </div>
                            ...
                            <table id="attendance-rpt-tbl" class="table table-bordered">
                                <thead>
                                    <tr class="bg-primary bg-opacity-75">
                                        <th class="text-center bg-primary text-light" style="width:300px !important">Étudiants</th>
                                        ...
                                        <th class="text-center bg-primary text-light">TR</th>
                                        <th class="text-center bg-primary text-light">TA</th>
                                        <th class="text-center bg-primary text-light">TJ</th>
                                    </tr>
                                </thead>
                                <tbody>
                                                    ...
                                                    <?php 
                                                        ...
                                                        switch(($row['attendance'][$class_month."-".$i] ?? '')){
                                                            case 1:
                                                                ...
                                                                break;
                                                            case 2:
                                                                echo "<span class='text-body-emphasis fw-bold'>R</span>";
                                                                $tl += 1;
                                                                break;
                                                            case 3:
                                                                ...
                                                                break;
                                                            case 4:
                                                                echo "<span class='text-primary fw-bold'>J</span>";
                                                                $th += 1;
                                                                break;
                                                        }
                                                    ?>
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="<?= $monthLastDay + 5 ?>" class="px-2 py-1 text-center">Aucun étudiant répertorié pour le moment</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
